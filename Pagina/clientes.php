  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../Insertar/insertarClientes.php" method="POST">
            <div>
...
<div class="tablas">
    <tr>
        ...
        <td><?php echo $val["NIT"]?></td>
        <td>
          <a href="../borrar/BorrarEmpleado.php?id=<?=$val["id_cliente"]?>&req='delete'" class="btn btn-danger">BORRAR</a>
        </td>
        <td>
          <a href="../editar/EditarEmpleado.php?id=<?=$val["id_cliente"]?>" class="btn btn-warning">EDITAR</a>
        </td>
    </tr>
</div>
