  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../Insertar/insertarConstructora.php" method="POST">
            <div>
...
<div class="tablas">
    <tr>
        <td><?php echo $val["id_constructora"]?></td>
        <td><?php echo $val["nombre"]?></td>
        <td><?php echo $val["telefono"]?></td>
        <td><?php echo $val["direccion"]?></td>
        <td>
          <a href="../borrar/BorrarTodo.php?id=<?=$val["id_constructora"]?>&req='delete'" class="btn btn-danger">BORRAR</a>
        </td>
        <td>
          <a href="../editar/EditarConstructora.php?id=<?=$val["id_constructora"]?>" class="btn btn-warning">EDITAR</a>
        </td>
    </tr>
</div>
